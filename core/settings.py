...
SIMPLE_JWT = {
    ...
    # "TOKEN_OBTAIN_SERIALIZER": "apps.authentication.serializers.SecureDeviceTokenObtainPairSerializer",
    "TOKEN_OBTAIN_SERIALIZER": "apps.authentication.serializers.SecureDeviceLoginSerializer",
}
...
import base64
RSA_PRIVATE_KEY = base64.b64decode(env.str("RSA_PRIVATE_KEY_B64")).decode()
RSA_PUBLIC_KEY = base64.b64decode(env.str("RSA_PUBLIC_KEY_B64")).decode()
